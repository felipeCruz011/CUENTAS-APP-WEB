...
$consulta_transferencias = $pdo->prepare("SELECT * FROM transacciones ORDER BY id DESC");
if ($fecha !== "") {
    $consulta_transferencias = $pdo->prepare("SELECT * FROM transacciones WHERE fecha LIKE '%" .$fecha. "%' ORDER BY id DESC");
